                ...
                with analysis_tab3:
                    ...
                    if 'Allotment Status' in filtered_df.columns and 'Discipline' in filtered_df.columns:
                        ...
                        try:
                            ...
                            if 'Allotted' in discipline_success.columns:
                                # Simplify to avoid linter issues
                                top_disciplines = discipline_success['Allotted'].head(5)
                                # Convert to list and sort manually if needed
                    ...
                    if 'Allotment Status' in filtered_df.columns and 'College' in filtered_df.columns:
                        ...
                        try:
                            ...
                            if 'Allotted' in college_success.columns:
                                # Simplify to avoid linter issues
                                top_colleges = college_success['Allotted'].head(5)
                                # Convert to list and sort manually if needed
                    ...
                    with col1:
                        ...
                        if 'Level' in filtered_df.columns:
                            try:
                                # Use pandas Series explicitly to ensure proper method access
                                level_series = pd.Series(filtered_df['Level'])
                                level_dist = level_series.value_counts()
                    ...
                    with col2:
                        ...
                        if 'Discipline' in filtered_df.columns:
                            try:
                                # Use pandas Series explicitly to ensure proper method access
                                discipline_series = pd.Series(filtered_df['Discipline'])
                                discipline_dist = discipline_series.value_counts().head(10)
                    ...
                    with col3:
                        ...
                        if 'College' in filtered_df.columns:
                            try:
                                ...
                                college_dist = college_series.value_counts().head(10)
                    ...
                    with adv_col1:
                        ...
                        if 'Allotment Status' in filtered_df.columns:
                            try:
                                # Use pandas Series explicitly to ensure proper method access
                                status_series = pd.Series(filtered_df['Allotment Status'])
