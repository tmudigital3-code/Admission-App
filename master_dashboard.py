...
with st.sidebar:
    ...
    enquiry_uploaded_files = st.sidebar.file_uploader("Choose Enquiry CSV Files", type=['csv'], key="enquiry_upload", accept_multiple_files=True, help="Upload CSV with enquiry data including Enquiry No., Enquiry Date, and other relevant fields")
